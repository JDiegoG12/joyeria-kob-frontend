...
export const PublicProductCard = ({
  ...
  return (
    ...
    >
      {/*
       * Zona de imagen a sangre (sin marco): la foto ocupa todo el ancho de la
       * tarjeta, sin padding interno. `aspect-square` mantiene la proporción
       * cuadrada y `object-cover` rellena el área sin deformar el producto.
       * Las flechas y los puntos se posicionan respecto a esta misma caja.
       */}
      <div
